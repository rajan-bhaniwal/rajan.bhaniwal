resource "azurerm_policy_definition" "modify-vm-ahub-win" {
  name         = "modify-vm-ahub-win"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "Modify - Windows Virtual Machines should be deployed with Azure Hybrid Use Benefit"
...
output "policydefinition_modify-vm-ahub-win" {
  value = azurerm_policy_definition.modify-vm-ahub-win
}
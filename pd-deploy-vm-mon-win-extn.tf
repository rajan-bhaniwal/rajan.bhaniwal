resource "azurerm_policy_definition" "deploy-vm-mon-win-extn" {
  name         = "deploy-vm-mon-win-extn"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "Deploy - Configure Windows virtual machines to run Azure Monitor Agent"
...
output "policydefinition_deploy-vm-mon-win-extn" {
  value = azurerm_policy_definition.deploy-vm-mon-win-extn
}
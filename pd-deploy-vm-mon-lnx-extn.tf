resource "azurerm_policy_definition" "deploy-vm-mon-lnx-extn" {
  name         = "deploy-vm-mon-lnx-extn"
  policy_type  = "Custom"
  mode         = "All"
  display_name = "Deploy - Configure Linux virtual machines to run Azure Monitor Agent"
...
output "policydefinition_deploy-vm-mon-lnx-extn" {
  value = azurerm_policy_definition.deploy-vm-mon-lnx-extn
}
resource "azurerm_policy_definition" "deploy-vm-dep-win-extn" {
  name         = "deploy-vm-dep-win-extn"
  policy_type  = "Custom"
  mode         = "All"
...
output "policydefinition_deploy-vm-dep-win-extn" {
  value = azurerm_policy_definition.deploy-vm-dep-win-extn
}